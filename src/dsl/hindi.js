...
exports.rules = [
  ...
  {lhs: "object$macro$1$modifier$1", rhs: [], transform: builtin_base_cases["?"], score: 0},
  {lhs: "object$macro$1$modifier$1", rhs: [{type: "determiner"}], transform: builtin_recursives["?"], score: 0},
  {lhs: "object$macro$1$modifier$2", rhs: [], transform: builtin_base_cases["?"], score: 0},
  {lhs: "object$macro$1$modifier$2", rhs: ["adjective_phrase"], transform: builtin_recursives["?"], score: 0},
  {lhs: "object$macro$1", rhs: ["object$macro$1$modifier$1", "_", "object$macro$1$modifier$2", "_", "noun_oblique"], transform: new template.Template("{determiner: $0, modifiers: $2, ...$4}",[true,false,true,false,false]), syntaxes: [{"indices":[4,0,2],"tense":{}}]},
  {lhs: "object$macro$1$modifier$3", rhs: [], transform: builtin_base_cases["?"], score: 0},
  {lhs: "object$macro$1$modifier$3", rhs: [{type: "determiner"}], transform: builtin_recursives["?"], score: 0},
  {lhs: "object$macro$1$modifier$4", rhs: [], transform: builtin_base_cases["?"], score: 0},
  {lhs: "object$macro$1$modifier$4", rhs: ["adjective_phrase"], transform: builtin_recursives["?"], score: 0},
  {lhs: "object$macro$1", rhs: ["object$macro$1$modifier$3", "_", {type: "number"}, "_", "object$macro$1$modifier$4", "_", {type: "noun"}], transform: new template.Template("{count: $2, determiner: $0, modifiers: $4, noun: $6}",[true,false,false,false,true,false,false]), syntaxes: [{"indices":[2,6,0,4],"tense":{}}]},
  ...
  {lhs: "verb_phrase", rhs: ["object", "_", {type: "copula"}], transform: new template.Template("{verb: \"be\", object: $0}",[false,false,false]), syntaxes: [{"indices":[2],"tense":{}}]},
