...
exports.rules = [
  ...
  {lhs: "dict_item", rhs: ["key", {text: ":"}, "_", "template"], transform: (d) => [d[0], d[3]]},
  ...
  {lhs: "key$subexpression$1", rhs: [{type: "identifier"}]},
  {lhs: "key$subexpression$1", rhs: [{type: "string"}]},
  {lhs: "key", rhs: ["key$subexpression$1"], transform: (d) => d[0][0]},
