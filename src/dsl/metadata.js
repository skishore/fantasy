...
exports.rules = [
  ...
  {lhs: "item", rhs: [{text: "("}, "_", {text: "?"}, "_", "syntax", "_", {text: ")"}], transform: (d) => ({type: 'syntax', syntaxes: d[4]})},
  {lhs: "item", rhs: [{text: "("}, "_", {text: "="}, "_", "tokens", "_", {text: ")"}], transform: (d) => ({type: 'template', template: d[4]})},
  {lhs: "syntax$modifier$1", rhs: [], transform: builtin_base_cases['?']},
  {lhs: "syntax$modifier$1$subexpression$1", rhs: ["check", "_"]},
  {lhs: "syntax$modifier$1", rhs: ["syntax$modifier$1$subexpression$1"], transform: builtin_recursives['?']},
  {lhs: "syntax$modifier$2", rhs: [], transform: builtin_base_cases['?']},
  {lhs: "syntax$modifier$2", rhs: ["extra"], transform: builtin_recursives['?']},
  {lhs: "syntax", rhs: ["syntax$modifier$1", "syntax$modifier$2"], transform: (d) => [d[0] ? d[0][0] : []].concat(d[1] || [])},
  ...
  {lhs: "score", rhs: ["number"], transform: (d) => d[0]},
  {lhs: "score", rhs: ["number", "_", {text: "*"}, "_", {text: "$"}, {type: "integer"}], transform: (d) => ({i: d[5], score: d[0]})},
  ...
  {lhs: "token$subexpression$1", rhs: [{type: "float"}]},
