...
exports.grammar = {
  rules: [
    {lhs: "main$modifier$1", rhs: []},
    {lhs: "main$modifier$1$subexpression$1", rhs: ["_", "item"]},
    {lhs: "main$modifier$1", rhs: ["main$modifier$1", "main$modifier$1$subexpression$1"], transform: (d) => d[0].concat([d[1]])},
    ...
    {lhs: "scores$modifier$1", rhs: []},
    {lhs: "scores$modifier$1", rhs: ["scores$modifier$1", "score_suffix"], transform: (d) => d[0].concat([d[1]])},
    ...
    {lhs: "tokens$modifier$1", rhs: []},
    {lhs: "tokens$modifier$1$subexpression$1", rhs: ["_", "token"]},
    {lhs: "tokens$modifier$1", rhs: ["tokens$modifier$1", "tokens$modifier$1$subexpression$1"], transform: (d) => d[0].concat([d[1]])},
