...
exports.grammar = {
  rules: [
    ...
    {lhs: "term", rhs: ["word"], transform: (d) => ({type: 'term', term: d[0]})},
    {lhs: "term", rhs: [{type: "string"}], transform: (d) => ({type: 'term', term: {text: d[0]}})},
    {lhs: "term", rhs: [{text: "%"}, "word"], transform: (d) => ({type: 'term', term: {type: d[1]}})},
