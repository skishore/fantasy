...
exports.rules = [
  ...
  {lhs: "expr$macro$1$modifier$1$subexpression$1", rhs: ["_", {text: ","}, "_", "arg"]},
  ...
  {lhs: "expr$macro$1", rhs: ["arg", "expr$macro$1$modifier$1"], transform: (d) => [d[0]].concat(d[1].map((x) => x[3]))},
  ...
  {lhs: "arg", rhs: [{text: "$"}, "word"], transform: (d) => ({type: 'binding', name: d[1]})},
  {lhs: "arg", rhs: ["term"], transform: (d) => ({type: 'term', term: d[0]})},
