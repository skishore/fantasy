...
// https://github.com/thomcc/pcg-random/blob/master/pcg-random.js
...
var PcgRandom = (function() {
  ...
  PcgRandom.prototype.setSeed = function(
    seedHi: number,
    seedLo: number,
    incHi: number,
    incLo: number,
  ...
  PcgRandom.prototype.setState = function(
  ...
  PcgRandom.prototype.integer = function(max: number) {
    if (!max) {
      return this.next_();
    }
    max = max >>> 0;
...
// A simple TypeScript interface around this type.
